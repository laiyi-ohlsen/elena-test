...
function createImageGallery(project) {
  ...
  if (image3) gallery.appendChild(createImageElement(image4));
  if (image3) gallery.appendChild(createImageElement(image5));
  if (image3) gallery.appendChild(createImageElement(image6));
